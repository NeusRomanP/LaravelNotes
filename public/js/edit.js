...
var editButton = document.getElementById("submitEdit"); //console.log(user);
...
function getUsers() {
  var location = window.location.href.split("/"); //console.log(location[location.length-1]);
  ...
  if (user.value.trim() != "") {
    ...
    axios.post('/notes/' + location[location.length - 1] + "/" + user.value, {
      ...
      if (document.getElementById) resp.data.forEach(function (res) {
        var element = document.createElement("div");
        var node = document.createTextNode(res.name);
...
function addSharedUser(sharedUser) {
  var shared_users_container = document.getElementById("users-to-share-with");
  var element = document.createElement("div");
  var shared_user_span = document.createElement("span");
  var node = document.createTextNode(sharedUser);
  var removeElement = document.createElement("span");
  var removeElementNode = document.createTextNode("Remove");
...
document.addEventListener("click", function (event) {
  var users_container = document.getElementById("users-container"); //console.log(event.target.id);
...
editButton.addEventListener("click", function () {
  ...
  var formData = new FormData();
  formData.append("prova", "prova"); //formData.append('_method', 'POST');
